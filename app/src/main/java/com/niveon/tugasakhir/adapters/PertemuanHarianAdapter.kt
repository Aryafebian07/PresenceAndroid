...
class PertemuanHarianAdapter(private var _data: List<JsonObject>,private val fragmentManager: FragmentManager) :
    RecyclerView.Adapter<PertemuanHarianAdapter.PertemuanHarianViewHolder>() {
    ...
    class PertemuanHarianViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PertemuanHarianViewHolder {
        val itemView = LayoutInflater.from(parent.context)
            .inflate(R.layout.list_pertemuanharian_item, parent, false)
        return PertemuanHarianViewHolder(itemView)
    }

    override fun onBindViewHolder(holder: PertemuanHarianViewHolder, position: Int) {
